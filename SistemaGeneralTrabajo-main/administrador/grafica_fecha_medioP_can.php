...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) :
        ...
        $results      = find_asesorV_by_datesC($start_date, $end_date);
        $results2      = find_asistenteV_by_datesC($start_date, $end_date);
        $results3      = find_comparecencia_by_datesC($start_date, $end_date);
        $results4      = find_escrito_by_datesC($start_date, $end_date);
        $results5      = find_vTelefonica_by_datesC($start_date, $end_date);
        $results6      = find_vElectronica_by_datesC($start_date, $end_date);
        $results7      = find_cndh_by_datesC($start_date, $end_date);
    else :
        $session->msg("d", $errors);
        redirect('tabla_estadistica_canalizacion.php', false);
    endif;
} else {
        ...
        <div class="page-break">
            <center>
                ...
                <div id="prueba">
                    ...
                    <center>
                        <h3 style="margin-top: 2%;">Estadísticas de Canalizaciones por medio de presentación del <?php if (isset($start_date)) {
                                                                                                                    echo $start_date;
