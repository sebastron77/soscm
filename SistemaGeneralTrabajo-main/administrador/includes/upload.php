...
class  Media {
  ...
  public $fileType;
  public $fileTempPath;
  //Establece destino para el upload
 ...
 /*--------------------------------------------------------------*/
 /* Funcion para procesar el archivo multimedia
 /*--------------------------------------------------------------*/
  public function process_media(){
    ...
    if(file_exists($this->productPath."/".$this->fileName)){
      $this->errors[] = "El archivo con el nombre {$this->fileName} ya  existe.";
      return false;
    }
  ...
  /*--------------------------------------------------------------*/
  /* Funcion para procesar imagen de usuario
  /*--------------------------------------------------------------*/
 public function process_user($id){
    ...
    if(!$id){
      $this->errors[] = " Falta ID de usuario.";
      return false;
    }
 ...
 /*--------------------------------------------------------------*/
 /* Funcion para actualizar imagen de usuario
 /*--------------------------------------------------------------*/
 ...
 /*--------------------------------------------------------------*/
 /* Funcion para eliminar imagen anterior
 /*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
/* Funcion para eliminar archivo por id
/*--------------------------------------------------------------*/
