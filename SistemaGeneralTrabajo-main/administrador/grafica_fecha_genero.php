...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) :
        ...
        $results      = find_hombre_by_dates($start_date, $end_date);
        $results2      = find_mujer_by_dates($start_date, $end_date);
        $results3      = find_lgbtiq_by_dates($start_date, $end_date);
        $results32      = find_lgbtiq_by_dates2($start_date, $end_date);
    else :
        ...
        <div class="page-break">
            <center>
                ...
                <div id="prueba">
                    ...
                    <center>
                        <h3 style="margin-top: 2%;">Estadísticas de Orientaciones por género del <?php if (isset($start_date)) {
                                                                                                        echo $start_date;
