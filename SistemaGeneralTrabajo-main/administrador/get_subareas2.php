<?php
	...
	?>
	<label for="area_hija2" style="color: black;">Selecciona Subárea</label>
	<select class="form-control" id="area_hija2" name="area_hija2" style="width: 30%;" onchange="this.form.action()">
