...
<center>
  ...
  <div id="prueba">
    <center>
      <h3 style="margin-top: 10px;">Estadística de Quejas (Por medio autoridad responsable)</h3><br>
    </center>
      ...
      <div style="width:45%; float:left;">
        ...
        <script>
          ...
          const mPresentacion = new Chart(ctx5, {
            type: 'bar',
            data: {
              labels: ['Aeropuerto de Morelia', 'Colegio de Bachilleres del Estado de Michoacán COBAEM','Colegio de Estudios Científicos y Tecnológicos del Estado de Michoacán CECYTEM',
              'Colegio Nacional de Educación Profesional Técnica CONALEP','Comisión Coordinadora del Transporte Publico en Michoacán','Comisión Ejecutiva Estatal de Atención a Victimas'],
              datasets: [{
