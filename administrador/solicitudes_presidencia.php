...
<div class="row" style="margin-top: 10px;">
    <div class="col-md-3" style="height: 13.5rem;">
        <div class="panel panel-box clearfix">
            ...
            <div class="panel-value pull-right">
                <p style="font-size: 15px; margin-top:5%; color:white;">Resoluciones</p>
    ...
    <div class="col-md-3" style="height: 13.5rem;">
        <div class="panel panel-box clearfix">
            ...
            <div class="panel-value pull-right">
                <p style="font-size: 15px; margin-top:4%; color:white; line-height: 100%;">Consejo de la CEDH</p>
                <div style="margin-top:-5%;">
                    <?php if ($nivel_user <= 2) : ?>
...
>>>>>>> 1b6e45897824c0bb5c5191c78632d579e3f961e6
    ...
    <div class="col-md-3" style="height: 13.5rem;">
        <div class="panel panel-box clearfix">
            ...
            <div class="panel-value pull-right">
                <p style="font-size: 15px; margin-top:5%; color:white; line-height: 100%;">Informe Anual de Actividades</p>
                <div style="margin-top:-3%;">
                    <?php if ($nivel_user <= 2) : ?>
...
<div class="row" style="margin-top: 10px;">
    ...
    <div class="col-md-3" style="height: 13.5rem;">
        <div class="panel panel-box clearfix">
            ...
            <div>
                <p style="font-size: 13px; margin-top:1%;">Recomendacio-<br>nes Generales</p>
                <div style="margin-top:-3%;">
                    <a style="margin-top:1%" href="add_recomendacion_general.php" class="btn btn-success btn-sm">Agregar</a>
                    <a style="margin-top:1%" href="recomendaciones_generales.php" class="btn btn-primary btn-sm">Ver</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3" style="height: 13.5rem;">
        <div class="panel panel-box clearfix">
            ...
            <div>
                <p style="font-size: 14px; margin-top:5%;">Agenda de Proyectos</p>
                <div style="margin-top:-3%;">
