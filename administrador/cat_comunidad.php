                                        ...
                                        <div class="btn-group">
                                            ...
                                            <?php if (($nivel == 1) && ($a_comunidades['id_cat_comun'] != 1)) : ?>
                                                ...
                                                <?php if ($a_comunidades['estatus'] == 0) : ?>
                                                    <a href="activate_comunidad.php?id=<?php echo (int)$a_comunidades['id_cat_comun']; ?>" class="btn btn-success btn-md" title="Activar" data-toggle="tooltip">
                                                        <span class="glyphicon glyphicon-ok"></span>
                                                    </a>
                                                <?php else : ?>
                                                    <a href="inactivate_comunidad.php?id=<?php echo (int)$a_comunidades['id_cat_comun']; ?>" class="btn btn-md btn-danger" data-toggle="tooltip" title="Inactivar">
                                                        <i class="glyphicon glyphicon-ban-circle"></i>
                                                    </a>
                                                <?php endif; ?>
                                                <a href="delete_comunidad.php?id=<?php echo (int)$a_comunidades['id_cat_comun']; ?>" class="btn btn-md btn-delete" data-toggle="tooltip" title="Eliminar" onclick="return confirm('¿Seguro que deseas eliminar esta Comunidad Indígena? Los procedimientos que esten relacionados a esta se establecerán como *Sin Dato*.');">
