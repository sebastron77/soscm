		...
		<body>
			...
			<table style="width: 100%; margin: 0 auto; text-align:center; font-size: 20px;">
				...
				<tr>
					...
					<td style="border-bottom: 1px solid #ccc;text-align:left;"><?php echo remove_junk(ucwords(utf8_decode(($e_detalle['nombre_quejoso'] . " " . $e_detalle['paterno_quejoso'] . " " . $e_detalle['materno_quejoso'])))) ?></td>
				</tr>
				<tr>
					<td style="text-align:right;">Agraviado:</td>
					<td style="border-bottom: 1px solid #ccc;text-align:left;"><?php echo remove_junk(ucwords(utf8_decode(($e_detalle['nombre_agraviado'] . " " . $e_detalle['paterno_agraviado'] . " " . $e_detalle['materno_agraviado'])))) ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="border-bottom: 1px solid #ccc;text-align:left;">
						<?php echo utf8_decode($derecho_vulnerado['descripcion']) ?>
					</td>
				</tr>
				<tr>
