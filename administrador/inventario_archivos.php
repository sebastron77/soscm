...
$page_title = 'Inventario Archivos';
        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <strong>
                    ...
                    <span>Inventario de Archivos</span>
                </strong>
				<?php if (($nivel_user <= 2) || ($nivel_user == 17) ) : ?>
                <a href="add_inventario_archivos.php" style="margin-left: 10px" class="btn btn-info pull-right">Agregar Registro</a>
				<?php endif; ?>
