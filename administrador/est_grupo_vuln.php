...
$page_title = 'Estadísticas Grupo Vulnerable';
require_once('includes/load.php');
$grupos = grupos_vuln((int)$_GET['id']);
    ...
    <div id="prueba">
      ...
      <div class=" row" style="display: flex; justify-content: center; align-items: center; margin-left:-70px;">
        ...
        <div style="width:50%; float:left;">
          ...
          <script>
            var yValues = [<?php foreach ($grupos as $grupo) : ?><?php echo $grupo['total']; ?>, <?php endforeach; ?>];
            ...
            const gVulnerableB = new Chart(ctx3, {
              type: 'bar',
              data: {
                labels: [<?php foreach ($grupos as $grupo) : ?> '<?php echo $grupo['descripcion']; ?>', <?php endforeach; ?>],
                datasets: [{
            ...
            <tbody style="background: white;">
              <?php $total=0;  foreach ($grupos as $grupo) : ?>
                <tr>
                  ...
                  <td>
                    <?php echo remove_junk(ucwords($grupo['total'])) ?>
                    <?php $total = $total + $grupo['total']; ?>
                  </td>
                </tr>
              <?php endforeach; ?>
              <tr>
