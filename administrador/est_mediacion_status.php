...
$page_title = 'Estadística Mediación-Status';
...
<div class="panel-body">
  ...
  <div id="prueba">
    <center>
        ...
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Mediación(Por Estatus)  <?php echo ($year==0?"":$year); ?></h2>
          ...
          <div class="row" style="display: flex; justify-content: center; align-items: center;">
            ...
            <div style="width:40%; float:left;">
              ...
              <script>
                var yValues = [<?php foreach ($mediacion as $datos) : ?><?php echo $datos['total']; ?>, <?php endforeach; ?>];
                ...
                const myChart = new Chart(ctx, {
                  type: 'bar',
                  data: {
                    labels: [<?php foreach ($mediacion as $datos) : ?> '<?php echo remove_junk(ucwords($datos['tipo'])); ?>', <?php endforeach; ?>],
                    datasets: [{
                      label: 'Quejas Mediación por Estatus',
                      data: yValues,
                      backgroundColor: [
            ...
            <div style="width:40%; float:right; margin-left: 50px;  margin-top: 40px">
              <table class="table table-bordered table-striped">
                ...
                <tbody style="background: white;">
                  <?php $total = 0;
                  foreach ($mediacion as $datos) : ?>
                    <tr>
                      <td>
                        <?php echo remove_junk(ucwords($datos['tipo'])) ?>
                      </td>
                      <td>
