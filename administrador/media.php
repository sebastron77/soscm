            ...
            <?php foreach ($media_files as $media_file) : ?>
              <tr class="list-inline">
                ...
                <td class="text-center">
                  <img src="uploads/products/<?php echo $media_file['nombre_archivo']; ?>" class="img-thumbnail" />
                </td>
                <td class="text-center">
                ...
                <td class="text-center">
                  <?php if ($nivel == 1) : ?>
                    <a href="delete_media.php?id=<?php echo (int) $media_file['id']; ?>" class="btn btn-danger btn-md" title="Eliminar">
