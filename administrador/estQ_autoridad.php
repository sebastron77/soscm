    ...
    <center>
        ...
        <div id="prueba">
            <center>
                ...
                <h2 style="margin-top: 15px; color: #3a3d44;">Estadística de Quejas (Por Autoridad)</h2>
                ...
                <div style="width:50%; float:left;">
                    ...
                    <script>
                        ...
                        const gVulnerableB = new Chart(ctx3, {
                            type: 'bar',
                            data: {
                                labels: [<?php foreach ($autoridades as $autoridad) : ?> '<?php echo $autoridad['nombre_autoridad']; ?>', <?php endforeach; ?>],
                                datasets: [{
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody style="background: white;">
                            <?php $total=0;  foreach ($autoridades as $autoridad) : ?>
                                <tr>
                                    <td>
                                        <?php echo remove_junk(ucwords($autoridad['nombre_autoridad'])) ?>
                                    </td>
                                    <td>
