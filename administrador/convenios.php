                ...
                <tbody>
                    <?php foreach ($all_convenios as $a_convenio) : ?>
                        <tr>
                            ...
                            <td><?php echo ($a_convenio['indefinido'] == 1 ? 'Indefinido' : 'Definida') ?></td>
                            ...
                            <td style="text-align: center;"><a target="_blank" style="color: #0094FF;" href="uploads/convenios/<?php echo $resultado . '/' . $a_convenio['documento_convenio']; ?>">
