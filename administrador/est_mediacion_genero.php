...
$page_title = 'Estadística Mediación-Género';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$year = isset($_GET['id']) ? $_GET['id'] : '0';
$solicitudes = medEstadistica('cat_genero','id_cat_gen',$year);
  ...
  <div id="prueba">
    <center>
      <?php if ((int)$_GET['id'] == 1) : ?>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Mediación (Por género) <?php echo ($year==0?"":$year); ?></h2>
        <?php endif; ?>        
              ...
              <script>
                ...
                const myChart = new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      label: 'Quejas Mediación por Género',
                      data: yValues,
                      backgroundColor: [
