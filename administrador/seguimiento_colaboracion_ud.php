    ...
    <div class="panel panel-default">
        ...
        <div class="row">
					...
					<div class="form-group">
                            <label for="no_informe">Nombre Desaparecido</label>
						<input type="text" class="form-control" name="desaparecido_nombre" value="<?php echo remove_junk($e_detalle['desaparecido_nombre'])." ".remove_junk($e_detalle['desaparecido_paterno'])." ".remove_junk($e_detalle['desaparecido_materno']); ?>" disabled>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
                            <label for="fecha_entrega_informe">Fecha de desaparicion</label>
                            <input type="date" class="form-control" name="fecha_desparicion" value="<?php echo remove_junk($e_detalle['fecha_desparicion']); ?>" disabled>
                        </div>
				</div>
        </div>
		...
		<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<select class="form-control"  name="id_cat_ent_fed" id="id_cat_ent_fed" disabled>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="municipio" value="<?php echo remove_junk($e_detalle['municipio']); ?>" disabled>
					</div>
				</div>
		</div>	
		<div class="row">							
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="localidad" value="<?php echo remove_junk($e_detalle['localidad']); ?>" disabled>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<textarea class="form-control" name="observaciones" cols="10" rows="5" disabled><?php echo ucwords($e_detalle['observaciones']); ?></textarea>
					</div>
				</div>
		</div>
