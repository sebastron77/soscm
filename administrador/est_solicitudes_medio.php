...
$page_title = 'Estadística Solicitude-Medio de Presentación';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$solicitudes = solEstadistica('cat_medio_pres_ut','id_cat_med_pres_ut', 'descripcion');
  ...
  <div id="prueba">
    <center>
      <?php if ((int)$_GET['id'] == 1) : ?>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Solicitude de Información (Por Medio de Presentación)</h2>
        <?php endif; ?>        
              ...
              <script>
                ...
                const myChart = new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      label: 'Solicitude de Información por Medio de Presentación',
                      data: yValues,
                      backgroundColor: [
