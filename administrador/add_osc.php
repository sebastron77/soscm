...
<div class="row">
    <div class="panel panel-default">
        ...
        <div class="container">
            <img class="img-round" src="medios/LOGO-CEDH-H.png" alt="Imagen Miniatura" data-toggle="modal" data-target="#imagenModal">
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Imagen Grande</h5>
