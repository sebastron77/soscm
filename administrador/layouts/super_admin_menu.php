<ul>
  <li style="margin-top: 18px;">
    <a href="admin.php" style="left: 18px; top:2px">
      ...
      <!--      <svg style="width:22px;height:22px" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Inicio</title><path d="M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z" /></svg>  -->
      <span style="position: absolute; top: 50%; left: 50%; margin:-11px 0 0 -85px;">Panel de control</span>
    </a>
  </li>
  ...
  <li style="margin-top:18px;">
    <a href="#" class="submenu-toggle" style="left: 18px; top:20px">
      <svg style="width:22px;height:22px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
    ...
    <ul style="margin-top:25px" class="nav submenu">
      <li><a href="detalles_usuario.php">Administrar Trabajadores</a> </li>
  ...
  <li style="margin-top: 18px;">
    ...
    <ul style="margin-top:25px" class="nav submenu">
      ...
      <li><a href="cat_hecho_vulnerado.php">Hecho Vulnerado</a> </li>
  ...
  <li style="margin-top: 18px;">
    <a href="reporteador_general.php" class="submenu-toggle" style="left: 18px; top:20px">
  ...
  <li style="margin-top: 18px;">
    <a href="search_all.php" class="submenu-toggle" style="left: 18px; top:20px">
	
	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
		  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
		</svg>      
      <span style="position: absolute; top: 50%; left: 50%; margin:-11px 0 0 -85px;">Buscador</span>
    </a>
