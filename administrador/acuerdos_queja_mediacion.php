...
if (isset($_POST['acuerdo_mediacion'])) {
    ...
    if (empty($errors)) {
        ...
        $estado_mediacion = remove_junk($db->escape($_POST['estado_mediacion']));
		...
		$query2 = "UPDATE quejas_dates SET estado_mediacion='{$estado_mediacion}' WHERE id_queja_date='{$db->escape($id)}'";
        ...
        <div class="panel-body">
            <form method="post" action="acuerdos_queja_mediacion.php?id=<?php echo (int) $e_detalle['id_queja_date']; ?>" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo remove_junk(($datos['fecha_acuerdo'])) ?></td>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;
                ...
                <div class="row" style="border-radius: 10px 10px 10px 10px;">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="estado_mediacion">Estado Mediacion</label>
						<select class="form-control" name="estado_mediacion">
						<option value="">Escoge una opción</option>  
                            <?php foreach ($cat_estatus_mediacion as $dato) : ?>
                                    <option value="<?php echo $dato['id_cat_estatus_mediacion']; ?>"><?php echo ucwords($dato['descripcion']); ?></option>
                                <?php endforeach; ?>
								</select>
                        </div>
                    </div>
