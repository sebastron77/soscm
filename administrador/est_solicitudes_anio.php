...
$page_title = 'Estadística Solicitude-Tipo Solicitud';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$solicitudes = solicanios('2023');
  ...
  <div id="prueba">
    <center>
      <?php if ((int)$_GET['id'] == 1) : ?>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Solicitude de Información (Por Tipo de Solicitud)</h2>
        <?php endif; ?>        
            ...
            <div style="width:40%; float:left;">
              ...
              <script>
                ...
                const myChart = new Chart(ctx, {
                  type: 'bar',
                  data: {
                    labels: [<?php foreach ($solicitudes as $datos) : if ((int)$datos['mes'] <= 12) { $nombre_mes= $meses[$datos['mes'] - 1]; } ?> '<?php echo $nombre_mes; ?>', <?php endforeach; ?>],
                    datasets: [{
                      label: 'Solicitude de Información por Tipo de Solicitud',
                      data: yValues,
                      backgroundColor: [
              ...
              <table class="table table-bordered table-striped">
                <thead class="thead-purple">
                  <tr style="height: 10px;">
                    <th class="text-center" style="width: 70%;">Mes</th>
