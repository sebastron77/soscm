...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) :
        ...
        $results      = find_lgbt_by_datesC($start_date, $end_date);
        $results1      = find_lgbt_by_dates2C($start_date, $end_date);
        $results2      = find_ddm_by_datesC($start_date, $end_date);
        $results3      = find_nna_by_datesC($start_date, $end_date);
        $results32      = find_nna_by_dates2C($start_date, $end_date);
        $results4      = find_pDiscapacidad_by_datesC($start_date, $end_date);
        $results5      = find_pMigrantes_by_datesC($start_date, $end_date);
        $results6      = find_vih_by_datesC($start_date, $end_date);
        $results7      = find_gIndigenas_by_datesC($start_date, $end_date);
        $results8      = find_periodistas_by_datesC($start_date, $end_date);
        $results9      = find_ddh_by_datesC($start_date, $end_date);
        $results10      = find_aMayores_by_datesC($start_date, $end_date);
        $results11      = find_internos_by_datesC($start_date, $end_date);
        $results12      = find_otros_by_datesC($start_date, $end_date);
        $results13      = find_na_by_datesC($start_date, $end_date);
    else :
        ...
        <div class="page-break">
            <center>
                ...
                <div id="prueba">
                    ...
                    <center>
                        <h3 style="margin-top: 2%;">Estadísticas de Canalizaciones por grupo vulnerable del <?php if (isset($start_date)) {
                                                                                                                echo $start_date;
