...
<center>
  ...
  <div id="prueba">
    <center>
      <h2 style="margin-top: 15px;">Estadística de Orientaciones (Por grupo vulnerable)</h2>
    </center>
      ...
      <div style="width:40%; float:right; margin-left: 50px;  margin-top: 40px">
        <table class="table table-dark table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td>Derecho de las mujeres</td>
              <?php if ($total_der_mujer['total'] != 0) { ?>
            ...
            <tr>
              ...
              <?php if (($total_nna['total'] != 0) || $total_nna2['total'] != 0) { ?>
